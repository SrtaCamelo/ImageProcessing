...
def experiment(dataset):
    ...
    for i in range(5):
        ...
        n_class = len(list(data))
        _class = (list(data))[-1]

        kfold_call(data, 1, (n_class -1), str(_class))

    # --------------These code lines above Do de SD, median and mean calculus---------------------------

    List_ofLists = [(tree_acuracy, "Tree"), (nb_acuracy, "Naive bayes"), (knn_1_acuracy, "KNN -1"),
                    (knn_3_acuracy, "KNN -3"),
                    (knn_5_acuracy, "KNN -5"), (wknn_1_acuracy, "WKNN-1"), (wknn_3_acuracy, "WKNN-3"),
                    (wknn_5_acuracy, "WKNN-5"),
    ...
    List_ofListx = [(tree_time, "Tree"), (nb_time, "Naive bayes"), (knn_1_time, "KNN -1"), (knn_3_time, "KNN -3"),
                    ...
                    (svm_linear_time, "SVM-Linear"), (svm_rbf_time, "SVM-RBF"), (logi_time, "Logistic Regression"),
                    (neural_time, "MLP")]
    print("ACURACY\n")
